...
print('Hello, {}. I am years old'.format('mangju', 100))

# 2. count() 메소드 : 특정 문자나 문자열이 등장하는 횟수를 세는데 사용
...
# 4. index() 메소드 : 특정 문자나 문자열이 처름 등장하는 인덱스를 반환
# 찾고자 하는 문자나 문자열이 없을 경우 ValueError가 발생
...
# 8. replace() 메소드 : 특정 문자나 문자열을 다른 문자나 문자열로 대체
print('Hello, World'.replace('World', 'Python'))

# 9. 불필요한 문자열 제거 메소드
print('   Hello   '.strip()) # 문자열 양쪽 끝의 공백 및 다른 특정 문자 제거
print('   Hello   '.lstrip())
print('   Hello   '.rstrip())
