...
student_list = []
with open('D:\\python-bt0720\\python-bt0803-lmj\\0803\\File_IO\\student.csv', 'rt', encoding='utf-8') as file:
    file.readline()
    while True:
        line = file.readline()
        if not line:
...
with open('D:\\python-bt0720\\python-bt0803-lmj\\0803\\File_IO\\student.csv', 'r',encoding='utf-8') as file:
