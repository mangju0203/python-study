...
print(man1.name)
print(man1.age)
print(man1.address) # 인스턴스 변수는 해당 인스턴스에서 불러옫기 가능

# 클래스 변수는 인스턴스 또는 클래스 모두에게서 불러오기 가능
print(Korean.address)
print(man1. address)
...
class MyClass:
    ...
    def show_class_variable(self):
        print(self.class_variable) #인스턴스 내에서 클래스 변수에 접근가능